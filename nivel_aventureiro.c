#include<stdio.h>                                                                                              // Acessa a Biblioteca,que faz com que haja entrada e saída de dados
  ...
  int main(){                                                                                                      // Função para que o programa funcione
    ...
    float PIB1;                                                                                              //Declara o formato da variável PIB1 como float (número de ponto fluante(número com casas decimais))                                                                                             //Declara o formato da variável área1 como float (número de ponto fluante(número com casas decimais))  
